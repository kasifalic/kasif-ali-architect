      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="relative">
          <div className="relative w-80 h-80 mx-auto bg-gradient-to-r from-primary/30 to-accent/30 rounded-full flex items-center justify-center animate-float">
            <img alt="Kasif Ali" className="w-72 h-72 rounded-full object-cover border-4 border-primary/50" src="/lovable-uploads/670c51f8-10c7-4095-bf8a-fc6925cc396c.jpg" />
          </div>
